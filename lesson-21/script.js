...
const mixedArray = [1, '5', 3, 'abc', null, 10, '20', 0];
const avg = average(mixedArray);
console.log(avg);
...
console.log(average(['hello', 12, 'hi', 3, 4, 'another hell', 1, '5', 7, 'end', 0, 'you again?', 8]));


console.log(average([34, 'call me', 23, 'no, call me!', '11', 48, null, 51, {}, 37, undefined, 20, [], 26]));
